...
public class AnimatedExpandableListView extends ExpandableListView {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private void stopAnimation(int groupPosition) {
            ...
            info.flatPos = parent.getFlatListPosition(getPackedPositionForGroup(groupPosition));
            Log.d("pos", info.flatPos + "");
            if(info.flatPos>-1 && info.expanding)
                parent.smoothScrollToPositionFromTop(info.flatPos,1,300);
        }
