...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public static final int PIN_TYPE = 7;
    ...
    public SweetAlertDialog(Context context) {
        this(context, NORMAL_TYPE,null,null);
    }

    public SweetAlertDialog(Context context, int alertType, Typeface tf1, Typeface tf2) {
